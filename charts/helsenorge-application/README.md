...
| debug | object | `{"configShare":"/config-share/","debugConfigMap":"debug-environment"}` | Debugmodus - konfigurasjon for oppsett |
...
| isDebugEnvironment | bool | `false` | Debugmodus - begrenset til utviklings- og testmiljoer. |
